...
export default function SlidingImages({ side, images, speed = 50, containerClass = "" }: SlidingImagesProps) {
  ...
  return (
    <div className={`absolute ${side}-0 w-24 md:w-40 overflow-hidden pointer-events-none ${containerClass}`}>
      <div 
