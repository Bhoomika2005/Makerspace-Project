  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 rounded-md">
        <div>
          <span className="font-semibold text-[#0610ab]">First Name:</span>{" "}
          {firstName}
        </div>
        <div>
          <span className="font-semibold text-[#0610ab]">Last Name:</span>{" "}
          {lastName}
        </div>
        <div>
        ...
        <div>
          <span className="font-semibold text-[#0610ab]">Status:</span>{" "}
          {isAdmin ? "Admin" : "User"}
        </div>
      </div>
    </div>
