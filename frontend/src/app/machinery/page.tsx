    ...
    <div className="container mx-auto px-4 py-8">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEquipmentData({ ...equipmentData, quantity: Number.parseInt(e.target.value) })}
                    className="col-span-3"
                  />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="image" className="text-right border border-black">
                    Image
                  </Label>
                  <Input
                    id="image"
      ...
      <div className="flex flex-col gap-6 max-w-4xl mx-auto">
        {equipment.map((item, index) => (
          <Card key={item.id} className="overflow-hidden hover:shadow-lg transition-transform transform hover:scale-105 rounded-xl ">
